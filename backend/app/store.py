...
INITIAL_STATE = OperationsState(
    ...
    customers=[
        Customer(id="c-1", name="Mina Yılmaz", channel="WhatsApp", phone="+90 532 000 1414", email="mina.yilmaz@example.com"),
        Customer(id="c-2", name="Arda Market", channel="Email", phone="+90 216 000 2020", email="orders@ardamarket.example"),
        Customer(id="c-3", name="Selin Kaya", channel="WhatsApp", phone="+90 555 000 3030", email="selin.kaya@example.com"),
        Customer(id="c-4", name="Kuzey İskele Kafe", channel="Phone", phone="+90 212 000 4040", email="satinalma@kuzeyiskele.example"),
        Customer(id="c-5", name="Ahmet Bey", channel="WhatsApp", phone="+90 533 000 5050", email="ahmet.bey@example.com"),
        Customer(id="c-6", name="Dara Boutique", channel="Email", phone="+90 212 000 6060", email="hello@daraboutique.example"),
        Customer(id="c-7", name="Fırın 38", channel="WhatsApp", phone="+90 352 000 7070", email="siparis@firin38.example"),
        Customer(id="c-8", name="Liva Otel Satın Alma", channel="Email", phone="+90 242 000 8080", email="purchasing@livaotel.example"),
        Customer(id="c-9", name="Deniz Ergin", channel="WhatsApp", phone="+90 544 000 9090", email="deniz.ergin@example.com"),
        Customer(id="c-10", name="Mavi Kooperatif", channel="Phone", phone="+90 232 000 1010", email="operasyon@mavikoop.example"),
        Customer(id="c-11", name="Esra Atelier", channel="Email", phone="+90 212 000 1111", email="studio@esraatelier.example"),
        Customer(id="c-12", name="Lotus Vegan Cafe", channel="WhatsApp", phone="+90 216 000 1212", email="hello@lotusvegan.example"),
    ],
    orders=[
